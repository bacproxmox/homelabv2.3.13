...
- v2.2'de çalışan app-config mimarisi v2.3.13 path/naming düzenine refactor edildi.
...
```bash
cd /root
rm -rf /root/homelabv2.3.13
git clone https://github.com/bacproxmox/homelabv2.3.13.git /root/homelabv2.3.13
cd /root/homelabv2.3.13
