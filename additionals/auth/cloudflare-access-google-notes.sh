...
Bu ayar Cloudflare Zero Trust dashboard tarafında yapılır. v2.3.13 scriptleri tunnel/route üretir, Access policy'leri ise güvenli şekilde dashboard veya ileride API token ile yönetilebilir.
MSG
