...
echo
echo "🔐 Homelab v2.3.13 - Nextcloud Google Social Login Provider"
echo
...
occ config:app:set sociallogin custom_providers --value="$PROVIDERS"
...
echo
echo "📋 Kontrol:"
occ config:app:get sociallogin custom_providers || true
