...
echo
echo "📸 Homelab v2.3.13 - Immich Reset + Final Configurator"
echo
...
grep -qs " /mnt/private/photos " /etc/fstab || echo "192.168.50.101:/mnt/private/photos /mnt/private/photos nfs defaults,_netdev,x-systemd.automount,nofail 0 0" >> /etc/fstab
