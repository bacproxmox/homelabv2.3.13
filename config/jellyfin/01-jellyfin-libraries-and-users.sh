...
echo
echo "🎬 Homelab v2.3.13 - Jellyfin Post-Setup Configurator"
echo
...
# v2.3.13: Jellyfin viewer users use passwords collected in users.env.
...
# v2.3.13: Jellyfin server name should be stable and branded, not random/container-derived.
echo
...
echo "ℹ️ v2.3.13: Orhan otomatik viewer listesinde yok. ORHAN_PASS eklenirse bile default olarak oluşturulmaz."
