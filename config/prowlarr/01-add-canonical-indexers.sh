...
ARR_SSH_USER="${BACMASTER_USER:-bacmaster}"
...
FLARE_INDEXERS=(
  # v2.3.13: Cloudflare-heavy definitions intentionally disabled by default.
  # Enable manually after confirming FlareSolverr/indexer access.
)

echo
echo "🧲 Homelab v2.3.13 - Prowlarr Indexer Automation"
