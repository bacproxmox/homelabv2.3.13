...
echo "⏳ Uptime Kuma DB bekleniyor..."
DB_FILE=""
for i in {1..120}; do
...
[[ -n "$DB_FILE" ]] || { echo "❌ Uptime Kuma DB bulunamadı."; find /opt/homelab/uptime-kuma -maxdepth 4 -type f | sort || true; exit 1; }
...
monitors=[
 ...
 ('Nextcloud','http','http://192.168.50.104:8080','',None,0),
